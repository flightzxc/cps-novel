...
NEW_ROWS: dict[str, list[str]] = {
    ...
    "arranged-marriage": ["Arranged Marriage", "Matrimonio concertado", "Casamento arranjado", "Pernikahan diatur", "Hôn nhân sắp đặt", "แต่งงานคลุมถุงชน", "親が決めた結婚", "중매결혼", "包辦婚姻", "زواج مرتب", "Mariage arrangé", "Arrangierte Ehe", "Małżeństwo zaaranżowane", "Domluvené manželství", "Брак по договорённости семей"],
    ...
    "blind-date": ["Blind Date", "Cita a ciegas", "Encontro às cegas", "Kencan buta", "Xem mắt", "นัดบอด", "お見合い", "맞선", "相親", "موعد أعمى", "Rendez-vous à l’aveugle", "Blind Date", "Randka w ciemno", "Rande naslepo", "Свидание вслепую"],
    ...
    "campus": ["Campus", "Campus", "Campus", "Kampus", "Học đường", "ชีวิตในโรงเรียนและมหาวิทยาลัย", "学園", "캠퍼스", "校園", "الحياة المدرسية والجامعية", "Campus", "Campus", "Kampus", "Kampus", "Кампус"],
    ...
    "child-centered-romance": ["Adorable Kids", "Niños adorables", "Crianças adoráveis", "Anak-anak menggemaskan", "Ngôn tình bé cưng", "เด็กน่ารัก", "萌えベビー題材", "귀여운 아기 소재", "萌寶題材", "ثيمة الطفل اللطيف", "Thématique bébé mignon", "Süßes-Baby-Thema", "Motyw uroczego bobasa", "Téma roztomilého miminka", "Тема милого малыша"],
    ...
    "comeback": ["Comeback", "Resurgimiento", "Retorno triunfal", "Kebangkitan", "Lội ngược dòng", "คัมแบ็ก", "逆転", "역전", "逆襲", "قلب الموازين", "Retour en force", "Comeback", "Odwrócenie losu", "Obrat k lepšímu", "Камбэк"],
    ...
    "cross-dressing": ["Cross-dressing", "Vestirse con ropa del otro género", "Vestir roupas do outro gênero", "Menyamar lawan jenis", "Giả trang nam/nữ", "แต่งตัวข้ามเพศ", "女装／男装", "여장/남장", "異裝", "ارتداء ملابس الجنس الآخر", "Travestissement", "Crossdressing", "Przebieranie się za inną płeć", "Převlek do druhého pohlaví", "Переодевание в одежду другого пола"],
    ...
    "ensemble-darling": ["Ensemble Darling", "El consentido de todos", "Queridinho de todos", "Kesayangan semua orang", "Được mọi người cưng chiều", "Darling ของทุกคน", "全員から愛される", "모두에게 사랑받는 주인공", "團寵", "محبوب الجميع", "Chouchou de tous", "Liebling aller", "Ulubieniec wszystkich", "Miláček všech", "Любимчик всех"],
    ...
    "estrangement": ["Estrangement", "Alejamiento", "Afastamento", "Keterasingan", "Xa cách", "ห่างเหิน", "疎遠", "멀어진 관계", "關係疏離", "قطيعة", "Éloignement", "Entfremdung", "Wyobcowanie", "Odcizení", "Отчуждение"],
    ...
    "frenemies": ["Frenemies", "Amigos-enemigos", "Amigos-inimigos", "Teman sekaligus musuh", "Bạn-thù", "เพื่อนรักเพื่อนแค้น", "友であり敵", "프렌에미", "亦敵亦友", "أصدقاء-أعداء", "Amis-ennemis", "Frenemies", "Przyjaciele-wrogowie", "Přátelé-nepřátelé", "Друзья-враги"],
    ...
    "legitimate-daughter": ["Legitimate Daughter", "Hija legítima", "Filha legítima", "Putri sah", "Đích nữ", "บุตรสาวภรรยาเอก", "嫡女", "적녀", "嫡女", "الابنة الشرعية", "Fille légitime", "Eheliche Tochter", "Prawowita córka", "Legitimní dcera", "Законная дочь"],
    ...
    "love-after-marriage": ["Love After Marriage", "Amor después del matrimonio", "Amor depois do casamento", "Cinta setelah menikah", "Yêu sau hôn nhân", "รักหลังแต่ง", "結婚してから恋に落ちる", "결혼 후 사랑", "先婚後愛", "حب بعد الزواج", "Amour après le mariage", "Erst heiraten, dann lieben", "Miłość po ślubie", "Láska po svatbě", "Любовь после свадьбы"],
    ...
    "male-audience": ["Male Audience", "Público masculino", "Público masculino", "Untuk pembaca pria", "Dành cho nam", "สำหรับผู้อ่านชาย", "男性向け", "남성향", "男性向", "موجه للرجال", "Public masculin", "Für männliche Leser", "Dla czytelników męskich", "Pro mužské čtenáře", "Для мужской аудитории"],
    ...
    "one-night-stand": ["One-Night Stand", "Aventura de una noche", "Ficada de uma noite", "Hubungan semalam", "Tình một đêm", "ความสัมพันธ์ชั่วคืน", "一夜限り", "원나잇", "一夜情", "علاقة لليلة واحدة", "Aventure d’un soir", "One-Night-Stand", "Przygoda na jedną noc", "Jedna noc", "Связь на одну ночь"],
    ...
    "single-mom-escape": ["Single Mom Escape", "Huida de una madre soltera", "Fuga de uma mãe solteira", "Pelarian ibu tunggal", "Mẹ đơn thân bỏ trốn", "แม่เลี้ยงเดี่ยวหนี", "シングルマザーの逃走", "싱글맘의 탈출", "帶娃逃離", "هروب أم عزباء", "Fuite d’une mère célibataire", "Flucht einer alleinerziehenden Mutter", "Ucieczka samotnej matki", "Útěk svobodné matky", "Побег матери-одиночки"],
    "single-mother": ["Single Mother", "Madre soltera", "Mãe solteira", "Ibu tunggal", "Mẹ đơn thân", "แม่เลี้ยงเดี่ยว", "シングルマザー", "싱글맘", "單親媽媽", "أم عزباء", "Mère célibataire", "Alleinerziehende Mutter", "Samotna matka", "Svobodná matka", "Мать-одиночка"],
    "son-in-law-comeback": ["Son-in-Law Comeback", "El yerno contraataca", "O genro contra-ataca", "Kebangkitan menantu", "Con rể phản kích", "ลูกเขยพลิกเกม", "婿入り逆転", "사위의 역전", "贅婿逆襲", "صعود الصهر", "Le gendre contre-attaque", "Die Rückkehr des Schwiegersohns", "Comeback zięcia", "Návrat zetě", "Камбэк зятя"],
    ...
    "student": ["Student", "Estudiante", "Estudante", "Pelajar", "Học sinh, sinh viên", "นักเรียนและนักศึกษา", "学生", "학생", "學生", "طالب", "Élèves et étudiants", "Schüler und Studierende", "Uczniowie i studenci", "Student", "Учащиеся"],
    ...
    "substitute-marriage": ["Substitute Bride", "Novia sustituta", "Noiva substituta", "Pernikahan pengganti", "Gả thay", "แต่งงานแทน", "身代わり結婚", "대신 결혼", "替嫁", "عروس بديلة", "Mariage par substitution", "Ersatzheirat", "Małżeństwo zastępcze", "Náhradní sňatek", "Брак по подмене"],
    "sudden-wealth": ["Sudden Wealth", "Riqueza repentina", "Riqueza súbita", "Kaya mendadak", "Phát tài bất ngờ", "รวยชั่วข้ามคืน", "一攫千金", "갑작스러운 부", "突然暴富", "ثروة مفاجئة", "Richesse soudaine", "Plötzlicher Reichtum", "Nagłe bogactwo", "Náhlé bohatství", "Внезапное богатство"],
    ...
    "warrior-protagonist": ["Warrior Protagonist", "Protagonista guerrero", "Protagonista guerreiro", "Protagonis pejuang", "Nhân vật chính chiến binh", "ตัวเอกนักรบ", "戦士の主人公", "전사 주인공", "戰士主角", "بطل محارب", "Protagoniste guerrier", "Krieger-Protagonist", "Wojownik jako protagonista", "Hlavní hrdina válečník", "Герой-воин"],
    ...
    "young-adult": ["Young Adult", "Juvenil", "Jovem adulto", "Remaja", "Thanh thiếu niên", "วัยรุ่น", "ヤングアダルト", "청소년", "青少年", "يافعون", "Young adult", "Jugendbuch", "Młodzieżowe", "Young adult", "Для подростков"],
}
...
def main() -> None:
    ...
    # or a (slug, locale) cell whose reused CPS value failed the 79df119 P1 sense audit.
    FORCE_NEW = {
        ("campus", "ar"),
        ("campus", "th"),
        ("comeback", "cs"),
        ("comeback", "pl"),
        ("family-feud", "zh-Hant"),
        ("historical-romance", "de"),
        ("love-after-marriage", "de"),
        ("mother-in-law", "zh-Hant"),
        ("student", "de"),
        ("student", "pl"),
        ("substitute-marriage", "ar"),
        ("substitute-marriage", "en"),
        ("substitute-marriage", "es"),
        ("substitute-marriage", "pt-BR"),
        ("substitute-marriage", "vi"),
        ("unrequited-love", "zh-Hant"),
    }
    ...
    artifact = {
        ...
        "review_scope": (
            ...
            "clear ambiguity, and concept mix-up. 2026-09-19 P1 audit applied 51 cells; "
            "P2 optional_suggestions were not applied. Not a full linguistic sign-off of every cell."
        ),
        "cache_note": (
