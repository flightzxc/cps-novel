...
describe("X8 local production-like contracts", () => {
  ...
  it("keeps the level table the single source of truth for both assertion sides", () => {
    ...
    expect(levelUat).toEqual(expect.arrayContaining(["batch.materialize.v1", "content.create.v1", "novel.materialize.v1", "article.generate.v1", "article.generate.batch.v1", "article.generate.batch.v2"]));
    expect(levelR).not.toEqual(expect.arrayContaining(["batch.materialize.v1", "content.create.v1", "novel.materialize.v1", "article.generate.v1", "article.generate.batch.v1", "article.generate.batch.v2"]));
