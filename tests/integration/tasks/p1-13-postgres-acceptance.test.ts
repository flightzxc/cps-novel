...
const frozenChecks: Record<string, readonly string[]> = {
  ...
  indexnow_outbox_attempt_outcome_check: ["started", "accepted", "retryable_failed", "permanent_failed"],
  indexnow_outbox_attempt_attempt_state_check: ["started", "completed", "unknown_outcome"],
