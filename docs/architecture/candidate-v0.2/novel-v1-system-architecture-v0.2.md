# 海外阅读 v1 · 总体技术架构 v0.2（候选）

> 文档性质：**架构候选**，待 Owner 审核。非 Owner 已确认。
> v0.2 修订：2026-08-02（Owner 裁决回灌 + CPS 同构性复核）。逐项变更见 `CHANGELOG-v0.1-to-v0.2.md`。
> CPS 代码基线：`d77c3b968285698529cf97c7f0f97b286d7a2a9c`（v8.1.1，树干净）
> 配套文档：`novel-v1-evidence-reconciliation.md`（证据，含 §8 v0.2 裁决回灌）、`novel-v1-logical-data-model-v0.2.md`（数据模型）、`novel-v1-adapter-and-workflow-v0.2.md`（契约与流程）、`novel-v1-implementation-plan-v0.2.md`（阶段计划）、`novel-v1-open-decisions.md`（待决）、`novel-v1-cps-parity-review.md`（CPS 五项同构性复核）
...
| 页面关系 | `Novel detail ├─ Chapter 1 ├─ Chapter 2 └─ Chapter N`——每页独立 SEO 页面，**不把章节页 canonical 指向详情页** |
