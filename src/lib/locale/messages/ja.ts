...
const messages = {
  nav: {
    ...
    about: "このサイトについて",
    copyright: "コンテンツと著作権",
    footerNote: "本サイトでは無料のプレビュー章をご用意しています。全編は原作プラットフォームでお楽しみいただけます。",
    language: "言語",
  },
  home: {
    works: "作品",
  ...
  chapter: {
    ...
    lastPreviewChapter: "これが最後のプレビュー章です",
    heading: "第{number}章",
    readerSettings: "読書設定",
    closeReaderSettings: "読書設定を閉じる",
    previewPosition: "プレビュー {index} / {total}",
    endOfPreview: "本サイトでのプレビューはここまでです。",
