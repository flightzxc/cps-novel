...
const messages = {
  nav: {
    ...
    footerNote: "Ta strona oferuje darmowe rozdziały podglądowe. Pełna historia jest dostępna na oryginalnej platformie.",
    language: "Język",
  },
  home: {
    works: "Dzieła",
  ...
  novel: {
    ...
    chapterCount: "Rozdziałów: {count}",
    previewCount: "Rozdziałów podglądu: {count}",
    startPreview: "Rozpocznij podgląd",
  ...
  chapter: {
    ...
    lastPreviewChapter: "To jest ostatni rozdział podglądu",
    heading: "Rozdział {number}",
    readerSettings: "Ustawienia czytania",
    closeReaderSettings: "Zamknij ustawienia czytania",
    previewPosition: "Podgląd {index} / {total}",
    endOfPreview: "To koniec podglądu na tej stronie.",
