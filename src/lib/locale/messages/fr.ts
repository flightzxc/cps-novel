...
const messages = {
  nav: {
    ...
    footerNote: "Ce site propose des chapitres d'aperçu gratuits. L'histoire complète se trouve sur la plateforme d'origine.",
    language: "Langue",
  },
  home: {
    works: "Œuvres",
  ...
  novel: {
    ...
    chapterCount: "Chapitres : {count}",
    previewCount: "Chapitres d'aperçu : {count}",
    startPreview: "Commencer l'aperçu",
    readOnUpstream: "Continuer la lecture",
    synopsis: "Résumé",
    previewChapters: "Chapitres d'aperçu",
    previewChaptersDescription: "{count} chapitres d'aperçu sur ce site, tous fournis par la plateforme d'origine.",
    previewChaptersDescriptionOne: "1 chapitre d'aperçu sur ce site, fourni par la plateforme d'origine.",
    noPreviewChapters: "Ce livre n'a pas encore de chapitres d'aperçu.",
  ...
  chapter: {
    ...
    lastPreviewChapter: "Ceci est le dernier chapitre d'aperçu",
    heading: "Chapitre {number}",
    readerSettings: "Réglages de lecture",
    closeReaderSettings: "Fermer les réglages de lecture",
    previewPosition: "Aperçu {index} / {total}",
    endOfPreview: "C'est la fin de l'aperçu sur ce site.",
  ...
  unavailable: {
    ...
    takedownBody: "À la demande du titulaire des droits, ce site ne propose plus ce livre. Ce retrait est définitif.",
  ...
  meta: {
    ...
    siteDescription: "Site de distribution de romans à l'étranger",
  },
